...
| [design/stdlib-stats-log.md](design/stdlib-stats-log.md) | **`lib/stats` + log.fields（Mid2 M10）** |
...
| [roadmap/browser-wasm-f.md](roadmap/browser-wasm-f.md) | **路线 F：媒体/文件/Canvas 等（Completed，F1–F5；v0.3.3）** |
