...
| 阶段 | 内容 | 状态 |
|------|------|------|
| **Q0** | CATALOG + `plugins/quantum` ping + L1 `ensure_plugin` | pending |
| **Q1** | 态向量；I/X/H/CX；`simulate` / `probabilities`；贝尔态 gold | pending |
...
验收金样（目标）：`tests/ext/quantum-bell-smoke.mq.md`、`quantum-draw-smoke.mq.md`、中文对称样例。
